      ...
      builder: (context) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            hintText: 'Enter task',
            filled: true,
            fillColor: Colors.white.withAlpha(204), // 0.8 opacity alternative
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          ...
                          size: 80,
                          color: Colors.grey.withAlpha(128), // 0.5 opacity alternative
                        ),
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 18,
                            color: Colors.grey.withAlpha(179), // 0.7 opacity alternative
                          ),
                        ),
                      ],
                    ),
